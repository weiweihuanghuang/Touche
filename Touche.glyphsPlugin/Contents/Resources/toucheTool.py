...
from vanilla import CheckBox, Group, List, ProgressSpinner, SquareButton, TextBox, FloatingWindow
...
class ToucheTool():
    ...
    def __init__(self):
        self.w = FloatingWindow((180, 340), u'Touché!', minSize=(180,340), maxSize=(1000,898))
        p = 10
        w = 160
